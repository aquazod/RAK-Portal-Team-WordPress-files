...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="blog-entry-inner clr <?php echo esc_attr( $inner_classes ); ?>">
		...
		<div class="blog-entry-content">
			...
			<?php
 			// Category.
// 			get_template_part( 'partials/entry/thumbnail-style/category' ); // Assem Ali 17th July 2024
...
<!-- 			<div class="blog-entry-bottom clr"> --> <!-- Assem Ali 18th July 2024, shows a line below the post content -->

				<?php
 				// Comments.
// 				get_template_part( 'partials/entry/thumbnail-style/comments' ); // Assem Ali 17th July 2024

				// Date.
			get_template_part( 'partials/entry/thumbnail-style/date' ); // Assem Ali 17th July 2024
				?>
